    ...
    def load_config(cls, config_path: Optional[str] = None) -> DroxAIConfig:
        ...
        if config_file.exists():
            try:
                ...
                logging.info(f"Warning: Could not load config file {config_file}: {e}")
            ...
            if key.startswith(env_prefix):
                ...
                if len(parts) == 2:
                    ...
                    if section_title in config_dict:
                        # We rely on the loose matching here for flexibility.
...
if __name__ == "__main__":
    ...
    logging.info("Generated appsettings.json")